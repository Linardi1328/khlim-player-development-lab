    ...
    <div className="login-page">
      <section className="login-story">
        ...
        <div className="login-message">
          ...
          <p>
            A place to see the progress, celebrate the effort, and build what
            comes next.
          </p>
          <div className="login-values">
            <span>
              01 <strong>Observe</strong>
            </span>
            <span>
              02 <strong>Develop</strong>
            </span>
            <span>
              03 <strong>Reflect</strong>
            </span>
          </div>
        </div>
        <Court />
      ...
      <section className="login-panel">
        <div className="login-form-wrap">
          ...
          <p className="login-disclaimer">
            An isolated prototype. Please do not enter real athlete or personal
            information.
          </p>
        </div>
      </section>
