...
const ms: Record<string, string> = {
  ...
  "Saved. Your development profile is up to date.": "Disimpan. Profil perkembangan anda telah dikemas kini.",
  "Development sections": "Bahagian perkembangan",
  "Every check-in adds to the story.": "Setiap semakan menambah kepada perjalanan.",
  "The numbers behind the practice.": "Nombor di sebalik latihan.",
  "Clear intentions. Observable progress.": "Niat yang jelas. Kemajuan yang boleh diperhatikan.",
  "The everyday work that makes a difference.": "Usaha harian yang membawa perubahan.",
  "Observations, encouragement and the next step.": "Pemerhatian, galakan dan langkah seterusnya.",
  ...
  "Could not update status. Try again.": "Tidak dapat mengemas kini status. Cuba lagi.",
  ...
  "Small steps. Consistent practice. Progress that lasts.": "Langkah kecil. Latihan konsisten. Kemajuan yang berkekalan.",
  "Coach": "Jurulatih",
  "Athlete": "Atlet",
  ...
  "Prototype": "Prototaip",
  "Built for development. Designed for possibility.": "Dibina untuk perkembangan. Direka untuk kemungkinan.",
  ...
  "Sign in to see the work behind the progress.": "Log masuk untuk melihat usaha di sebalik kemajuan.",
  "Explore with a lab account": "Terokai dengan akaun makmal",
  "All athletes and records are fictional.": "Semua atlet dan rekod adalah rekaan.",
  "An isolated prototype. Please do not enter real athlete or personal information.": "Prototaip terpencil. Jangan masukkan maklumat atlet sebenar atau maklumat peribadi.",
  ...
  "A place to see the progress, celebrate the effort, and build what comes next.": "Tempat untuk melihat kemajuan, menghargai usaha dan membina langkah seterusnya.",
  "Observe": "Perhati",
  "Develop": "Bangunkan",
  "Reflect": "Renung",
  "An experiment in long-term athlete development": "Eksperimen dalam perkembangan atlet jangka panjang",
  ...
  "Use a fictional name. This lab contains synthetic athletes only.": "Gunakan nama rekaan. Makmal ini hanya mengandungi atlet sintetik.",
  "A clear, encouraging focus for the athlete’s next stage.": "Fokus yang jelas dan menggalakkan untuk peringkat seterusnya atlet.",
  ...
  "Describe the observed skills and the next area to practice.": "Terangkan kemahiran yang diperhatikan dan bidang seterusnya untuk dilatih.",
  "Shooting": "Shooting",
  "Finishing": "Finishing",
  ...
  "Make it observable, such as 8 of 10 off-hand layups.": "Jadikan ia boleh diperhatikan, contohnya 8 daripada 10 layup tangan bukan dominan.",
  "Status": "Status",
  ...
  "Celebrate something specific and offer one clear next step. This is visible to the athlete.": "Raikan sesuatu yang khusus dan berikan satu langkah seterusnya yang jelas. Ini boleh dilihat oleh atlet.",
  "Draft with AI": "Draf dengan AI",
  "Drafting…": "Sedang menyediakan draf…",
  "AI draft": "Draf AI",
  "Review and edit this suggestion before saving.": "Semak dan ubah cadangan ini sebelum menyimpan.",
  "Saving…": "Menyimpan…",
  "Update": "Kemas kini",
  "Saved": "Disimpan",
  ...
  "Turn small improvements into a clearer picture of every athlete’s journey.": "Jadikan peningkatan kecil sebagai gambaran yang lebih jelas tentang perjalanan setiap atlet.",
  ...
  "Record a session from an athlete’s profile.": "Rekod sesi daripada profil atlet.",
  ...
  "Set a specific next step from an athlete profile.": "Tetapkan langkah seterusnya yang khusus daripada profil atlet.",
  "COACH’S REMINDER": "PERINGATAN JURULATIH",
  "Progress belongs to the player. Keep the conversation personal.": "Kemajuan milik pemain. Kekalkan perbualan secara peribadi.",
  "INDIVIDUAL JOURNEYS. SHARED COMMITMENT.": "PERJALANAN INDIVIDU. KOMITMEN BERSAMA.",
  "Know the person behind the player. Find their next step.": "Kenali individu di sebalik pemain. Cari langkah seterusnya.",
  ...
  "Try a different name or development group.": "Cuba nama atau kumpulan perkembangan yang lain.",
  ...
  "1 Exploring → 5 Advanced · Individual coaching observations": "1 Meneroka → 5 Lanjutan · Pemerhatian jurulatih individu",
  "Let’s find the starting point": "Mari cari titik permulaan",
  "Record assessment": "Rekod penilaian",
  "The first assessment will bring this skill picture to life.": "Penilaian pertama akan membentuk gambaran kemahiran ini.",
  "THE LONG VIEW": "PANDANGAN JANGKA PANJANG",
  "Progress over time": "Kemajuan dari semasa ke semasa",
  "Average of this athlete’s seven skill observations": "Purata tujuh pemerhatian kemahiran atlet ini",
  "Explore assessment history": "Terokai sejarah penilaian",
  "Progress takes a starting point": "Kemajuan memerlukan titik permulaan",
  "Check-ins will appear here over time.": "Semakan akan muncul di sini dari semasa ke semasa.",
  ...
  "Create a specific, achievable goal for this athlete.": "Cipta matlamat khusus yang boleh dicapai untuk atlet ini.",
  "Your coach will add a clear next step here.": "Jurulatih anda akan menambah langkah seterusnya yang jelas di sini.",
  "THE TARGET": "SASARAN",
  ...
  "A first check-in will establish the starting point.": "Semakan pertama akan menetapkan titik permulaan.",
  "A baseline is the first step": "Garis asas ialah langkah pertama",
  "Record measurement": "Rekod ukuran",
  "Add a result and its measurement protocol to begin tracking progress.": "Tambah keputusan dan protokol ukuran untuk mula menjejaki kemajuan.",
  "Higher": "Lebih tinggi",
  "Lower": "Lebih rendah",
  "is better under comparable conditions": "lebih baik dalam keadaan yang setanding",
  "No results for this metric yet.": "Belum ada keputusan untuk metrik ini.",
  "Measurement history": "Sejarah ukuran",
  "Compare results using the same protocol. Shooting percentages use percentage points for changes.": "Bandingkan keputusan menggunakan protokol yang sama. Peratusan shooting menggunakan mata peratusan untuk perubahan.",
  "Ready for the next practice": "Sedia untuk latihan seterusnya",
  "Record training session": "Rekod sesi latihan",
  "Training notes connect the everyday work with long-term progress.": "Nota latihan menghubungkan usaha harian dengan kemajuan jangka panjang.",
  "Every effort deserves to be seen": "Setiap usaha wajar dihargai",
  "Add feedback": "Tambah maklum balas",
  "Specific, encouraging coach feedback will live here.": "Maklum balas jurulatih yang khusus dan menggalakkan akan dipaparkan di sini.",
  ...
  "A snapshot of today. A reference for tomorrow.": "Gambaran hari ini. Rujukan untuk esok.",
  "Give the next step a little more clarity.": "Jadikan langkah seterusnya lebih jelas.",
  "A shared 1–5 scale": "Skala 1–5 yang dikongsi",
  "1 Exploring · 2 Developing · 3 Consistent · 4 Confident · 5 Advanced": "1 Meneroka · 2 Berkembang · 3 Konsisten · 4 Yakin · 5 Lanjutan",
  "Rate against the athlete’s stage and the same observed drill conditions. These are coaching observations, not standardized scores.": "Nilai mengikut peringkat atlet dan keadaan latihan yang sama. Ini ialah pemerhatian jurulatih, bukan skor piawai.",
  "Reset your password": "Tetapkan semula kata laluan",
  "Enter your lab account email to continue.": "Masukkan e-mel akaun makmal anda untuk meneruskan.",
  ...
  "Password updated. You can sign in now.": "Kata laluan dikemas kini. Anda boleh log masuk sekarang.",
  "This local lab does not send email. The reset link is shown here for synthetic accounts only.": "Makmal tempatan ini tidak menghantar e-mel. Pautan tetapan semula dipaparkan di sini untuk akaun sintetik sahaja.",
...
const zh: Record<string, string> = {
  ...
  "Saved. Your development profile is up to date.": "已保存。你的成长档案已更新。",
  ...
  "Small steps. Consistent practice. Progress that lasts.": "小步前进。持续训练。让进步更长久。",
  "Coach": "教练",
  "Athlete": "运动员",
  "Lab account": "实验室账户",
  "Sign out": "退出登录",
  "Synthetic data": "合成数据",
  "Prototype": "原型",
  "Built for development. Designed for possibility.": "为成长而构建，为更多可能而设计。",
  ...
  "Sign in to see the work behind the progress.": "登录查看进步背后的训练与记录。",
  "Explore with a lab account": "使用实验室账户体验",
  "All athletes and records are fictional.": "所有运动员和记录均为虚构数据。",
  "An isolated prototype. Please do not enter real athlete or personal information.": "这是隔离的实验原型。请勿输入真实运动员或个人信息。",
  "PLAYER DEVELOPMENT LAB": "球员发展实验室",
  "Better players.": "成为更好的球员。",
  "One practice": "一次训练",
  "at a time.": "一步一步。",
  "A place to see the progress, celebrate the effort, and build what comes next.": "看见进步，肯定努力，并规划下一步。",
  "Observe": "观察",
  "Develop": "成长",
  "Reflect": "复盘",
  ...
  "Use a fictional name. This lab contains synthetic athletes only.": "请使用虚构姓名。本实验室仅包含合成运动员数据。",
  "A clear, encouraging focus for the athlete’s next stage.": "为运动员下一阶段设定清晰且鼓励性的重点。",
  ...
  "Describe the observed skills and the next area to practice.": "描述观察到的技能，以及下一步训练重点。",
  "Shooting": "投篮",
  "Finishing": "终结",
  "Ball handling": "控球",
  "Passing": "传球",
  ...
  "Due date": "目标日期",
  "Success target": "成功标准",
  "Make it observable, such as 8 of 10 off-hand layups.": "让目标可观察，例如非惯用手上篮 10 次进 8 次。",
  "Status": "状态",
  "Practice plan": "训练计划",
  "Session date": "训练日期",
  "Session type": "训练类型",
  ...
  "Celebrate something specific and offer one clear next step. This is visible to the athlete.": "肯定一个具体表现，并给出一个明确的下一步。运动员可以看到此反馈。",
  "Draft with AI": "AI 辅助起草",
  "Drafting…": "正在生成…",
  "AI draft": "AI 草稿",
  "Review and edit this suggestion before saving.": "保存前请先审核并编辑此建议。",
  "Saving…": "保存中…",
  "Update": "更新",
  "Saved": "已保存",
  "Not started": "未开始",
  ...
  "Turn small improvements into a clearer picture of every athlete’s journey.": "把每一次小进步汇集成清晰的成长轨迹。",
  ...
  "Set a specific next step from an athlete profile.": "从运动员档案中设定明确的下一步。",
  "COACH’S REMINDER": "教练提醒",
  "Progress belongs to the player. Keep the conversation personal.": "成长属于球员。让沟通保持个人化。",
  "INDIVIDUAL JOURNEYS. SHARED COMMITMENT.": "不同成长轨迹，共同投入。",
  "Know the person behind the player. Find their next step.": "了解球员背后的个人，并找到下一步。",
  ...
  "1 Exploring → 5 Advanced · Individual coaching observations": "1 探索 → 5 进阶 · 教练个人观察",
  "Let’s find the starting point": "先找到起点",
  "Record assessment": "记录评估",
  "The first assessment will bring this skill picture to life.": "第一次评估将建立技能起点。",
  "THE LONG VIEW": "长期视角",
  "Progress over time": "长期进步",
  "Average of this athlete’s seven skill observations": "该运动员七项技能观察的平均值",
  ...
  "Set a goal": "设定目标",
  "Create a specific, achievable goal for this athlete.": "为运动员设定具体且可实现的目标。",
  "Your coach will add a clear next step here.": "教练会在这里添加清晰的下一步。",
  "THE TARGET": "目标标准",
  "Review due": "需要复查",
  ...
  "A first check-in will establish the starting point.": "第一次评估将建立起点。",
  "A baseline is the first step": "先建立基线",
  "Record measurement": "记录测量",
  "Add a result and its measurement protocol to begin tracking progress.": "添加结果和测量方法，开始追踪进步。",
  "Higher": "更高",
  "Lower": "更低",
  "is better under comparable conditions": "在可比条件下更好",
  "No results for this metric yet.": "该指标暂无结果。",
  "Measurement history": "测量历史",
  "Compare results using the same protocol. Shooting percentages use percentage points for changes.": "请使用相同方法比较结果。投篮百分比的变化使用百分点表示。",
  "Ready for the next practice": "准备下一次训练",
  "Record training session": "记录训练",
  "Training notes connect the everyday work with long-term progress.": "训练备注把日常训练和长期进步联系起来。",
  "Every effort deserves to be seen": "每一次努力都值得被看见",
  "Add feedback": "添加反馈",
  "Specific, encouraging coach feedback will live here.": "具体且鼓励性的教练反馈会显示在这里。",
  ...
  "1 Exploring · 2 Developing · 3 Consistent · 4 Confident · 5 Advanced": "1 探索 · 2 发展中 · 3 稳定 · 4 自信 · 5 进阶",
  "Rate against the athlete’s stage and the same observed drill conditions. These are coaching observations, not standardized scores.": "请结合运动员阶段，并在相同训练条件下评分。这些是教练观察，并非标准化分数。",
  ...
  "This local lab does not send email. The reset link is shown here for synthetic accounts only.": "本地实验室不会发送邮件。仅针对合成测试账户在此显示重置链接。",
...
function translateDynamic(locale: Locale, value: string): string | null {
  ...
  const rules: Array<[RegExp, (match: RegExpMatchArray) => string]> = [
    ...
    [
      /^(\d+) sessions?$/,
      (match) =>
        locale === "ms" ? `${match[1]} sesi` : `${match[1]} 次训练`,
    ],
    [
      /^Due (.+)$/,
      (match) =>
...
export function translateUi(locale: Locale, value: string) {
  ...
  const translated = dictionaries[locale][core] ?? translateDynamic(locale, core) ?? core;
